...
router.get(
  ...
  authenticate,
  apiRateLimit,
  (req, res) => tradeController.getUserTrades(req, res)
);
...
router.get(
  ...
  authenticate,
  apiRateLimit,
  (req, res) => tradeController.getActiveTrades(req, res)
);
...
router.get(
  ...
  authenticate,
  apiRateLimit,
  (req, res) => tradeController.getTradeStats(req, res)
);
...
router.get(
  ...
  authenticate,
  apiRateLimit,
  (req, res) => tradeController.getTradeHistory(req, res)
);
...
router.get(
  ...
  authenticate,
  apiRateLimit,
  (req, res) => tradeController.getTodaysTrades(req, res)
);
...
router.get(
  ...
  authenticate,
  apiRateLimit,
  (req, res) => tradeController.getRecentTrades(req, res)
);
...
router.get(
  ...
  authenticate,
  apiRateLimit,
  (req, res) => tradeController.getTradeById(req, res)
);
...
router.get(
  ...
  authenticate,
  apiRateLimit,
  (req, res) => tradeController.getTradePositions(req, res)
);
...
router.post(
  ...
  authenticate,
  apiRateLimit,
  (req, res) => tradeController.manuallyCloseTrade(req, res)
);
