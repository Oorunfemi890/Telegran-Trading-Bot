...
// User routes
router.post("/", authenticate, apiRateLimit, (req, res) =>
  controller.submitRequest(req, res)
);

router.get("/my-requests", authenticate, apiRateLimit, (req, res) =>
  controller.getUserRequests(req, res)
);

// Admin routes
router.get("/admin/all", authenticate, requireAdmin, apiRateLimit, (req, res) =>
  controller.getAllRequests(req, res)
);
